...
Концепция идеальной формы организации информации, собранной из лучших сторон всех исторических форм с устранением их минусов: **«GitHub для знаний», скрещённый с Википедией и форумом**. Комплект из 23 документов:
...
- [_ledger.log](prototype/_ledger.log) — публичный журнал власти (append-only, **43 события**; действия ролей подписаны ключами)
...
- [dist/](prototype/dist/) — собранный сайт: канон, журнал власти (43 события), здоровье, черновики, RSS-фиды, федерация (8 Articles)
